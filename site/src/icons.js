...
library.add(
  ...
  faBriefcase, faCertificate, faCheckCircle, faChevronDown, faChildren,
  faChurch, faCircleExclamation, faClock, faCommentDots, faCompass,
  faCreditCard, faDownload, faEarthAmericas, faEnvelope, faEnvelopeOpen,
  faExclamationCircle, faExclamationTriangle, faEye, faFileSignature,
  faFlagUsa, faGavel, faGlobe, faGraduationCap, faHandHoldingHeart,
