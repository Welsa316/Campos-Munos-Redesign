...
library.add(
  ...
  faBriefcase, faCertificate, faCheckCircle, faChevronDown, faCircleExclamation,
  faClock, faCommentDots, faCompass, faCreditCard, faDownload, faEnvelope,
  faEnvelopeOpen, faExclamationCircle, faExclamationTriangle, faEye,
  faFileSignature, faGavel, faGlobe, faGraduationCap, faHandHoldingHeart,
  faIdCard, faInbox, faKey, faLink, faLocationDot, faLock, faMapMarkerAlt,
  faMessage, faPaperPlane, faPassport, faPeopleRoof, faPhone, faPlay, faRing,
  faRotateRight, faScaleBalanced, faShieldHalved, faSpinner, faStar, faUmbrella,
