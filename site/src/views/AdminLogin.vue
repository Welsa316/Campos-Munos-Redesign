  ...
  <div class="min-h-screen bg-brand-surface flex items-center justify-center px-6">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-10">
        ...
        <h1 class="font-[var(--font-heading)] text-2xl text-brand-navy">Admin Portal</h1>
      </div>
      ...
      <div class="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
        <form @submit.prevent="handleLogin" class="space-y-5">
          ...
          <transition name="fade">
            <p v-if="errorMsg" class="text-brand-red text-sm font-[var(--font-ui)]">
          ...
          <button
            type="submit"
            :disabled="loading"
            class="w-full bg-brand-navy text-white font-[var(--font-ui)] font-semibold tracking-wider text-sm py-4 rounded-xl btn-magnetic disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <span v-if="loading">
      ...
      <p class="text-center text-gray-400 text-xs font-[var(--font-ui)] mt-8">
