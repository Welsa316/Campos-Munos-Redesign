...
const members = {
  juan: {
    ...
    bio: 'Juan Campos-Gutierrez es el socio fundador de Campos Muños Law, LLC. Con más de veinte años de experiencia en derecho de inmigración, Juan ha dedicado su carrera a representar y defender los derechos de los inmigrantes en el sureste de los Estados Unidos. Su compromiso con la comunidad inmigrante y su profundo conocimiento de las leyes migratorias lo convierten en un defensor excepcional para sus clientes.',
  },
  angenette: {
  ...
  diana: {
    ...
    bio: 'Diana Arreaga sirve como Paralegal Senior en Campos Muños Law, LLC. Su dedicación y atención al detalle aseguran que cada caso reciba el cuidado y la preparación necesarios. Diana es un recurso invaluable para el equipo y para los clientes del bufete.',
  },
  rio: {
    key: 'rio', image: '/RioHeadshot.jpg',
    bio: 'Rio Shattuck es Asistente Legal en Campos Muños Law, LLC. Rio apoya al equipo legal en la preparación de documentos, investigación y comunicación con los clientes. Su dedicación al servicio contribuye significativamente al éxito del bufete.',
  },
}
